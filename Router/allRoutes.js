...
export const allRoutes = [
    ...
    new Route("/mesInformations", "Mes informations personnelles", "/pages/admin/mesInformations.html", ["ROLE_ADMIN"],["js/admin/mesInformations.js"]),
    new Route("/mesInformationsE", "Mes informations personnelles", "/pages/employe/mesInformations.html", ["ROLE_EMPLOYE"],["js/admin/mesInformations.js"]),
    new Route("/avis", "Avis", "/pages/employe/avis.html", ["ROLE_EMPLOYE"],["js/employe/avis.js"]),
    new Route("/covoituragesE", "Covoiturages", "/pages/employe/covoiturages.html", ["ROLE_EMPLOYE"],"/js/employe/covoiturages.js"),
